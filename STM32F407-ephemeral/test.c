...
int test_curve25519_DH_TV() {
  ...
  result |= crypto_scalarmult_base_curve25519(pk_A, sk_A);
  for (i = 0; i < 32; i++) {
  ...
  result |= crypto_scalarmult_base_curve25519(pk_B, sk_B);
  for (i = 0; i < 32; i++) {
  ...
  result |= crypto_scalarmult_curve25519(ss_A, sk_A, pk_B);
  for (i = 0; i < 32; i++) {
  ...
  result |= crypto_scalarmult_curve25519(ss_B, sk_B, pk_A);
  for (i = 0; i < 32; i++) {

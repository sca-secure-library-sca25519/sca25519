...
int
crypto_protectedKeyFromUnprotectedKey_scalarmult_curve25519(
       STProtectedStaticKey_curve25519 *k,
       const uint8_t* s);

void
crypto_updateProtectedKey_scalarmult_curve25519(STProtectedStaticKey_curve25519 *p);

// Protected static scalar multiplication
int
crypto_static_scalarmult_curve25519(
    uint8_t*       r,
    const STProtectedStaticKey_curve25519* s,
    const uint8_t* p);
...
void
update_static_key_curve25519(void);

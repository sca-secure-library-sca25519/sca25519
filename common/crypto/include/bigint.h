...
void multiply96x96(UN_192bitValue* result, const UN_96bitValue* x,
...
void square96(UN_192bitValue* result, const UN_96bitValue* x);
...
void multiply128x128(UN_256bitValue* result, const UN_128bitValue* x,
...
FORCE_INLINE static uint64_t multiply16x32(uint16_t x, uint32_t y) {
...
void square128(UN_256bitValue* result, const UN_128bitValue* x);
...
void square192(UN_384bitValue* result, const UN_192bitValue* x);
...
void multiply192x192(UN_384bitValue* result, const UN_192bitValue* x,
...
void multiply256x256(UN_512bitValue* result, const UN_256bitValue* x,
...
void square256(UN_512bitValue* result, const UN_256bitValue* x);
...
FORCE_INLINE static void swapPointersConditionally(void** p1, void** p2,
                                                   uint8_t condition);
...
FORCE_INLINE static uint8_t isNegative(signed char b) {
  // use a sequence that is constant time and not optimized away by the
  // compiler.
